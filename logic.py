...
class DB_Manager:
    ...
    def add_project(self, user_id, project_name, url, status_id, description=None):
        sql = """INSERT INTO projects 
    (user_id, project_name, description, url, status_id) 
    VALUES (?, ?, ?, ?, ?)"""
        self.__executemany(sql, [(user_id, project_name, description, url, status_id)])
